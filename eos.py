...
plt.plot(vol, ene-E0, 'ro')
plt.plot(vfit, eos_murnaghan(murn,vfit)-E0, label='Murnaghan')
plt.plot(vfit, eos_birch_murnaghan(birch_murn,vfit)-E0, label='Birch-Murnaghan')
plt.plot(vfit, eos_birch(birch,vfit)-E0, label='Birch')
plt.plot(vfit, eos_vinet(vinet,vfit)-E0, label='Vinet')
